...
Java_com_htc_horizonos_utils_PxScale_getpxRatioxy(JNIEnv *env, jobject thiz, jintArray px4, jintArray py4, jint oldRatio, jint newRatio, jfloat scale, jint w, jint h) {
    ...
    LOGD("CPP: Java_com_htc_horizonos debug_PxScale_getpxRatioxy");
...
Java_com_htc_horizonos_utils_PxScale_checkbddata(JNIEnv *env, jobject thiz, jstring data) {
	jint ret = 0;
	int i;
